<template>
  <div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
      ...
      <a
        href=""
        class="intro-y col-span-12 lg:col-span-4 box py-10 border-2 border-theme-17 dark:border-theme-17"
      >
        <ShieldIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
      ...
      <a href="" class="intro-y col-span-12 lg:col-span-4 box py-10">
        <TrendingUpIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
          ...
          <div id="faq-accordion-4" class="accordion p-5">
            <div class="accordion-item">
              ...
              <div
                ...
                class="accordion-collapse collapse show"
                aria-labelledby="faq-accordion-content-1"
                data-bs-parent="#faq-accordion-4"
              >
                <div class="accordion-body text-gray-700 dark:text-gray-600 leading-relaxed">
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                  Ipsum has been the industry's standard dummy text ever since the 1500s, when an
