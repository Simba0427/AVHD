        ...
        <div class="intro-y box mt-5">
          ...
          <div id="programmatically-show-hide-modal" class="p-5">
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-programmatically-show-hide-modal-js" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <!-- BEGIN: Show Modal Toggle -->
                      <div class="text-center">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-programmatically-show-hide-modal-html" class="source-preview">
                  ...
                  <div class="modal-content">
                    <div class="modal-body p-0">
                      <div class="p-5 text-center">
                        <XCircleIcon class="w-16 h-16 text-theme-23 mx-auto mt-3" />
                      ...
                      <div class="p-5 text-center border-t border-gray-200 dark:border-dark-5">
                        <a href="" class="text-theme-17 dark:text-gray-300"
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-body p-0">
                              <div class="p-5 text-center">
                                <XCircleIcon
                                  class="w-16 h-16 text-theme-23 mx-auto mt-3"
                                />
                                <div class="text-3xl mt-5">Oops...</div>
                                <div class="text-gray-600 mt-2">
                                  Something went wrong!
              ...
              <div id="button-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                      <div class="p-5 text-center">
                        <CheckCircleIcon class="w-16 h-16 text-theme-10 mx-auto mt-3" />
                  ...
                  <div class="modal-content">
                    <div class="modal-body p-0">
                      <div class="p-5 text-center">
                        ...
                        <div class="text-gray-600 mt-2">
                          Do you really want to delete these records? <br />This process cannot be
                          undone.
                        </div>
                      </div>
                      <div class="px-5 pb-8 text-center">
                        ...
                        >
                          ...
                          <div class="h-56 px-2">
                            <div class="h-full image-fit rounded-md overflow-hidden">
                              <img
                                alt="Icewall Tailwind HTML Admin Template"
                                :src="require(`@/assets/images/${$f()[0].images[2]}`)"
                              />
                            </div>
                          </div>
                          <div class="h-56 px-2">
                            <div class="h-full image-fit rounded-md overflow-hidden">
                              <img
                                alt="Icewall Tailwind HTML Admin Template"
                                :src="require(`@/assets/images/${$f()[0].images[3]}`)"
                              />
                            </div>
                          </div>
                        </TinySlider>
