          ...
          <div id="basic-progressbar" class="p-5">
            <div class="preview">
              ...
              <div class="progress mt-3">
                <div
                  class="progress-bar w-2/3 bg-theme-17"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
          ...
          <div id="progressbar-label" class="p-5">
            <div class="preview">
              <div class="progress h-4 rounded">
                <div
                  class="progress-bar w-1/2 bg-theme-17 rounded"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
              ...
              <div class="progress h-4 rounded mt-3">
                <div
                  class="progress-bar w-2/3 bg-theme-17 rounded"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
              ...
              <div class="progress h-4 rounded mt-3">
                <div
                  class="progress-bar w-3/4 bg-theme-17 rounded"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="progressbar-color" class="p-5">
            <div class="preview">
              ...
              <div class="progress mt-3">
                <div
                  class="progress-bar w-2/3 bg-theme-10"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
              ...
              <div class="progress mt-3">
                <div
                  class="progress-bar w-3/4 bg-theme-23"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
              ...
              <div class="progress mt-3">
                <div
                  class="progress-bar w-3/4 bg-theme-24"
                  role="progressbar"
                  aria-valuenow="0"
                  aria-valuemin="0"
                  aria-valuemax="100"
