      ...
      <div class="grid grid-cols-12 gap-6">
          ...
          <div class="report-box-2 intro-y mt-12 sm:mt-5">
            <div class="box sm:flex">
              <div class="px-8 py-12 flex flex-col justify-center flex-1">
                ...
                <Tippy
                  tag="div"
                  class="report-box-2__indicator bg-theme-10 cursor-pointer"
          ...
          <div class="report-box-2 intro-y mt-5">
            <div class="box p-5">
              ...
              <div class="border-b border-gray-200 flex pb-2 mt-4">
                ...
                <Tippy
                  tag="div"
                  class="text-theme-10 flex text-xs font-medium cursor-pointer ml-auto"
              ...
              <button class="btn btn-outline-secondary border-dashed w-full py-1 px-2 mt-4">
                Real-Time Report
              </button>
            </div>
          </div>
        ...
        <div class="col-span-12 lg:col-span-6 mt-6">
          <div class="ads-box box p-8 relative overflow-hidden bg-theme-17 intro-y">
            ...
            <button class="btn w-32 bg-white dark:bg-dark-2 dark:text-white mt-6 sm:mt-10">
              Start Now
            </button>
            <img
