        ...
        <div class="intro-y box">
          ...
          <div id="custom-content-preview-tooltip" class="p-5">
            <div class="preview">
              ...
              <div class="text-center">
                <a href="javascript:;" name="custom-tooltip-content" class="tooltip btn btn-primary"
                  >Show Tooltip</a
                >
              </div>
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-custom-content-preview-tooltip" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <!-- BEGIN: Custom Tooltip Toggle -->
                      <div class="text-center">
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="chart-preview-tooltip" class="p-5">
                ...
                <TippyContent to="chart-tooltip">
                  ...
                  <div class="flex items-center mt-2 sm:mt-0">
                    <div class="mr-2 w-20 flex dark:text-gray-600">
                      USP:
                      <span class="ml-auto font-medium text-theme-10">+23%</span>
                    </div>
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-chart-preview-tooltip" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <!-- BEGIN: Custom Tooltip Toggle -->
                      <div class="text-center">
