          ...
          <div id="basic-textual-notification" class="p-5">
            <div class="preview">
              <div class="text-center">
                ...
                >
                  ...
                  <a
                    class="font-medium text-theme-17 dark:text-gray-500 mt-1 sm:mt-0 sm:ml-40"
                    href=""
                    >Review Changes</a
                  >
                </div>
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-basic-textual-notification-html" class="source-preview">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-basic-textual-notification-js" class="source-preview">
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="success-notification" class="p-5">
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-success-notification-html" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="text-center">
                        <!-- BEGIN: Notification Content -->
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-success-notification-js" class="source-preview">
                  <code class="javascript text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="notification-with-actions" class="p-5">
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-actions-html" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="text-center">
                        <!-- BEGIN: Notification Content -->
                        ...
                        >
                          ...
                          <div class="ml-4 mr-4">
                            ...
                            <div class="font-medium flex mt-1.5">
                              <a class="text-theme-17 dark:text-gray-500" href=""
                                >Restart Now</a
                              >
                              <a class="text-gray-600 ml-3" href="">Cancel</a>
                            </div>
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-actions-js" class="source-preview">
                  <code class="javascript text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      // Notification with actions
        ...
        <div class="intro-y box">
          ...
          <div id="notification-with-avatar" class="p-5">
              ...
              <div class="text-center">
                ...
                <div id="notification-with-avatar-content" class="toastify-content hidden flex">
                  ...
                  <a
                    ...
                    class="absolute top-0 bottom-0 right-0 flex items-center px-6 border-l border-gray-200 dark:border-dark-5 font-medium text-theme-17 dark:text-gray-500"
                    href="javascript:;"
                    >Reply</a
                  >
                </div>
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-avatar-html" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="text-center">
                        <!-- BEGIN: Notification Content -->
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-avatar-js" class="source-preview">
                  <code class="javascript text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="notification-with-split-buttons" class="p-5">
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-split-buttons-html" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="text-center">
                        <!-- BEGIN: Notification Content -->
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-split-buttons-js" class="source-preview">
                  <code class="javascript text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      // Notification with split buttons
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="notification-with-buttons-below" class="p-5">
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-buttons-below-html" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="text-center">
                        <!-- BEGIN: Notification Content -->
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-notification-with-buttons-below-js" class="source-preview">
                  <code class="javascript text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
