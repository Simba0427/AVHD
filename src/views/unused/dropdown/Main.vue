        ...
        <div class="intro-y box mt-5">
          ...
          <div id="header-footer-dropdown" class="p-5">
                  ...
                  <div class="dropdown-menu w-56">
                    <div class="dropdown-menu__content box dark:bg-dark-1">
                      ...
                      <div class="p-2">
                        ...
                        >
                          <ActivityIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          Export to PDF
                        </a>
                        <a
                          href=""
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <BoxIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          Export to Excel
                          <div class="text-xs text-white px-1 rounded-full bg-theme-24 ml-auto">
                            10
                          </div>
                        </a>
                        <a
                          ...
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <LayoutIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          Export to CSV
                        </a>
                        <a
                          href=""
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <SidebarIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          Export to Word
                        </a>
                      </div>
                      <div
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-header-footer" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="flex justify-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu__content box dark:bg-dark-1">
                              ...
                              <div class="p-2">
                                ...
                                >
                                  ...
                                  Export to Excel
                                  <div
                                    class="text-xs text-white px-1 rounded-full bg-theme-24 ml-auto"
                                  >
                                    10
                                  </div>
                                </a>
          ...
          <div id="programmatically-show-hide-dropdown" class="p-5">
            <div class="preview">
              <div class="text-center">
                ...
                <button class="btn btn-primary w-40 mr-1 mb-2" @click="show">
                  Show
                </button>
                <!-- END: Show Modal Toggle -->
                <!-- BEGIN: Hide Modal Toggle -->
                <button class="btn btn-primary w-40 mr-1 mb-2" @click="hide">
                  Hide
                </button>
                <!-- END: Hide Modal Toggle -->
                <!-- BEGIN: Toggle Modal Toggle -->
                <button class="btn btn-primary w-40 mr-1 mb-2" @click="toggle">
                  Toggle
                </button>
                ...
                <div id="programmatically-dropdown" class="dropdown inline-block">
                  <button
                    class="dropdown-toggle btn btn-primary w-40 mr-1 mb-2"
                    aria-expanded="false"
                  >
                    Example Dropdown
                  </button>
            ...
            <div class="source-code hidden">
              <button
                data-target="#copy-programmatically-show-hide-dropdown-html"
                class="copy-code btn py-1 px-2 btn-outline-secondary"
              >
                <FileIcon class="w-4 h-4 mr-2" /> Copy example code
              </button>
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight
                  id="copy-programmatically-show-hide-dropdown-html"
              ...
              <button
                data-target="#copy-programmatically-show-hide-dropdown-js"
                class="copy-code btn py-1 px-2 btn-outline-secondary mt-5"
              >
                <FileIcon class="w-4 h-4 mr-2" /> Copy example code
              </button>
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-programmatically-show-hide-dropdown-js" class="source-preview">
        ...
        <div class="intro-y box mt-5">
          ...
          <div id="header-icon-dropdown" class="p-5">
                    ...
                    <div class="dropdown-menu__content box dark:bg-dark-1">
                      ...
                      <div class="p-2">
                        <a
                          ...
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <PrinterIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          Print
                        </a>
                        <a
                          href=""
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <ExternalLinkIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          Excel
                        </a>
                        <a
                          href=""
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <FileTextIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          CSV
                        </a>
                        <a
                          href=""
                          class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                        >
                          <ArchiveIcon class="w-4 h-4 text-gray-700 dark:text-gray-300 mr-2" />
                          PDF
                        </a>
                      </div>
                    </div>
            ...
            <div class="source-code hidden">
              ...
              <div class="overflow-y-auto mt-3 rounded-md">
                <Highlight id="copy-header-icon" class="source-preview">
                  <code class="text-xs p-0 rounded-md html pl-5 pt-8 pb-4 -mb-10 -mt-10">
                    <textarea>
                      <div class="flex justify-center">
                        <div class="dropdown">
            ...
            <div class="preview">
              <div class="text-center">
                <div class="dropdown inline-block" data-placement="top-start">
                  <button
                    class="dropdown-toggle btn btn-primary w-32 mr-1 mb-2"
                    aria-expanded="false"
                  >
                    Top Start
                  </button>
