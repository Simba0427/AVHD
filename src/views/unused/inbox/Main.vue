  ...
  <div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 xxl:col-span-2">
      ...
      <div class="intro-y box bg-theme-1 p-5 mt-6">
        <button
          type="button"
          class="btn text-gray-700 dark:text-gray-300 w-full bg-white dark:bg-primary-1 mt-1"
        >
        ...
        <div class="border-t border-theme-16 dark:border-dark-5 mt-6 pt-6 text-white">
          <a
            href=""
            class="flex items-center px-3 py-2 rounded-md bg-theme-17 dark:bg-dark-1 font-medium"
          >
        ...
        <div class="border-t border-theme-16 dark:border-dark-5 mt-4 pt-4 text-white">
          ...
          <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md truncate">
            <div class="w-2 h-2 bg-theme-24 rounded-full mr-3"></div>
            Next Week
          </a>
          <a href="" class="flex items-center px-3 py-2 mt-2 rounded-md truncate">
    ...
    <div class="col-span-12 lg:col-span-9 xxl:col-span-10">
      ...
      <div class="intro-y inbox box mt-5">
        ...
        <div class="overflow-x-auto sm:overflow-x-visible">
          <div v-for="(faker, fakerKey) in $f()" :key="fakerKey" class="intro-y">
            <div
            ...
            >
              <div class="flex px-5 py-3">
                ...
                <div class="w-64 sm:w-auto truncate">
                  <span class="inbox__item--highlight">{{ faker.news[0].superShortContent }}</span>
