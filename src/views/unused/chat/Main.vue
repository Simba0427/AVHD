            ...
            <div class="pr-1">
              <div class="box px-5 pt-5 pb-5 lg:pb-0 mt-5">
                <div class="relative text-gray-700 dark:text-gray-300">
                  <input
                    type="text"
                    class="form-control py-3 px-4 border-transparent bg-gray-200 pr-10 placeholder-theme-8"
            ...
            <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
              ...
              >
                ...
                <div
                  ...
                  class="w-5 h-5 flex items-center justify-center absolute top-0 right-0 text-xs text-white rounded-full bg-theme-17 font-medium -mt-1 -mr-1"
                >
        ...
        <div class="chat__box box">
          ...
          <div v-if="chatBox" class="h-full flex flex-col">
            ...
            >
                      ...
                      <div class="chat-dropdown__box box dark:bg-dark-1 flex flex-col pb-3 -mt-2">
                        <div class="px-3 pt-3">
                          <div class="relative text-gray-700 dark:text-gray-300">
                            <input
                              type="text"
                              class="form-control border-transparent bg-gray-200 pr-10 placeholder-theme-8"
              ...
              <a
                href="javascript:;"
                class="w-8 h-8 sm:w-10 sm:h-10 block bg-theme-17 text-white rounded-full flex-none flex items-center justify-center mr-5"
              >
