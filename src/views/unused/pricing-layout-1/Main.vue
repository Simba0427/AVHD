  ...
  <div>
    ...
    <div class="intro-y box flex flex-col lg:flex-row mt-5">
      <div class="intro-y flex-1 px-5 py-16">
        <CreditCardIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
      ...
      >
        <BriefcaseIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
      ...
      <div class="intro-y flex-1 px-5 py-16">
        <ShoppingBagIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
    ...
    <div class="intro-y box flex flex-col lg:flex-row mt-5">
      <div class="intro-y flex-1 px-5 py-16">
        <ActivityIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
        <div class="text-xl font-medium text-center mt-10">Basic Plan</div>
        <div class="text-gray-700 dark:text-gray-600 text-center mt-5">
          1 Domain <span class="mx-1">•</span> 10 Users <span class="mx-1">•</span> 20 Copies
        </div>
      ...
      >
        <BoxIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
        <div class="text-xl font-medium text-center mt-10">Business</div>
        <div class="text-gray-700 dark:text-gray-600 text-center mt-5">
          1 Domain <span class="mx-1">•</span> 10 Users <span class="mx-1">•</span> 20 Copies
        </div>
      ...
      <div class="intro-y flex-1 px-5 py-16">
        <SendIcon class="block w-12 h-12 text-theme-17 dark:text-gray-300 mx-auto" />
        <div class="text-xl font-medium text-center mt-10">Enterprise</div>
        <div class="text-gray-700 dark:text-gray-600 text-center mt-5">
          1 Domain <span class="mx-1">•</span> 10 Users <span class="mx-1">•</span> 20 Copies
        </div>
