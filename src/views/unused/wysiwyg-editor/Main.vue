      ...
      <div class="col-span-12 lg:col-span-6">
        <div class="box">
          ...
          <div id="simple-editor" class="p-5">
            <div class="preview">
              <CKEditor v-model="editorData" :editor="classicEditor" :config="simpleEditorConfig" />
            </div>
          ...
          <div id="document-editor" class="p-5">
            <div class="preview">
              <div class="document-editor">
                <div ref="document-editor-toolbar" class="document-editor__toolbar"></div>
...
export default defineComponent({
  setup() {
    ...
    const simpleEditorConfig = {
      plugins: [ParagraphPlugin, BoldPlugin, UnderlinePlugin, ItalicPlugin, LinkPlugin],
      toolbar: {
