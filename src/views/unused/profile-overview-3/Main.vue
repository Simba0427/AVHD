      ...
      <div class="col-span-12 lg:col-span-4 xxl:col-span-3 flex lg:block flex-col-reverse">
        ...
        <div class="intro-y box p-5 bg-theme-17 text-white mt-5">
          <div class="flex items-center">
            ...
            <div
              class="text-xs bg-white dark:bg-theme-17 dark:text-white text-gray-800 px-1 rounded-md ml-auto"
            >
              New
            </div>
          </div>
            ...
            <TinySlider ref-key="announcementRef" class="py-5">
              <div class="px-5">
                ...
                <div class="text-gray-700 dark:text-gray-600 mt-2">
                  ...
                  Ipsum has been the industry's standard dummy text ever. <br /><br />
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry since
                  the 1500s.
                </div>
                <div class="flex items-center mt-5">
                  <div
                    class="px-3 py-2 bg-theme-31 dark:bg-dark-5 dark:text-gray-300 text-theme-26 rounded font-medium"
                  >
                    02 June 2021
                  </div>
              ...
              <div class="px-5">
                ...
                <div class="mt-5">
                  ...
                  <div class="w-full h-1 mt-2 bg-gray-400 dark:bg-dark-1 rounded-full">
                    <div class="w-1/2 h-full bg-theme-17 rounded-full"></div>
                  </div>
                </div>
              </div>
              <div class="px-5">
                ...
                >
                  <div class="flex flex-col sm:flex-row items-center">
                    ...
                    <div class="w-full sm:w-auto flex items-center mt-3 sm:mt-0">
                      <div class="bg-theme-29 text-theme-10 rounded px-2 mr-5">
                        +20%
                      </div>
