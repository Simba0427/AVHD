      ...
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 xl:col-span-9 xxl:col-span-9 z-10">
          <div class="mt-6 -mb-6 intro-y">
            <div
              class="alert alert-dismissible show box bg-theme-14 text-white flex items-center mb-6"
              role="alert"
            >
              <span>
          ...
          <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
            ...
            >
              ...
              <div class="text-sm xxl:text-base font-medium -mb-1">
                Hi Angelina,
                <span class="text-gray-700 dark:text-gray-500 font-normal">welcome back!</span>
              </div>
              <div
              ...
              <div class="xxl:flex mt-5 mb-3">
                <div class="flex items-center justify-center sm:justify-start">
                  <div class="relative text-2xl xxl:text-3xl font-medium leading-6 pl-3 xxl:pl-4">
                    <span class="absolute text-xl xxl:text-2xl top-0 left-0 -mt-1 xxl:mt-0">$</span>
                    18,402,210
                  </div>
                ...
                >
                  <Tippy
                    tag="div"
                    class="font-medium inline-flex bg-theme-10 text-white rounded-full px-2 py-1 text-xs xxl:text-sm xxl:p-0 xxl:text-theme-10 xxl:bg-transparent xxl:flex items-center cursor-pointer xxl:justify-center"
              ...
              <div class="xxl:text-base text-gray-700 dark:text-gray-500 mt-6 -mb-1">
                Total net margin
                <span class="font-medium text-gray-800 dark:text-gray-400">$921,050</span>
              </div>
            ...
            >
              <div class="flex flex-wrap items-center">
                ...
                >
                  ...
                  <div class="ml-3.5">
                    <div
                      class="relative text-xl xxl:text-2xl font-medium leading-6 xxl:leading-5 pl-3.5 xxl:pl-4"
                    >
                      <span class="absolute text-base xxl:text-xl top-0 left-0 xxl:-mt-1.5">$</span>
                      47,578.77
                    </div>
            ...
            >
              <div
                class="boxed-tabs nav nav-tabs justify-center w-3/4 xxl:w-4/6 bg-theme-7 bg-opacity-50 text-gray-600 dark:bg-dark-2 dark:text-gray-500 rounded-md p-1 mx-auto"
                role="tablist"
              >
                <a
                  id="active-users-tab"
          ...
          <div class="grid grid-cols-12 gap-6 relative intro-y">
            <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 xxl:px-6">
              <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                ...
                <div
                  class="py-1 px-2 rounded-full text-xs bg-theme-7 bg-opacity-90 dark:bg-dark-5 text-gray-700 dark:text-gray-300 cursor-pointer truncate"
                >
                  180 Campaign
                </div>
              </div>
                  ...
                  >
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                      ...
                      <div class="mt-1.5 flex items-center">
                        ...
                        <Tippy
                          tag="div"
                          class="text-theme-24 flex text-xs font-medium cursor-pointer ml-2"
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                      ...
                      <div class="mt-1.5 flex items-center">
                        ...
                        <Tippy
                          tag="div"
                          class="text-theme-10 flex text-xs font-medium cursor-pointer ml-2"
                ...
                <div class="intro-x relative flex items-center mb-3">
                  ...
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    ...
                    <div class="text-gray-600 mt-1">
                      Has changed
                      <a class="text-theme-26 dark:text-theme-33" href="">{{
                        $f()[7].products[0].name
                      }}</a>
