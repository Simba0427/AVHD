<template>
  <div>
    ...
    <div class="intro-y box overflow-hidden mt-5">
      ...
      >
        <div class="font-semibold text-theme-17 dark:text-gray-300 text-3xl">
          INVOICE
        </div>
        <div class="mt-20 lg:mt-0 lg:ml-auto lg:text-right">
          <div class="text-xl text-theme-17 dark:text-gray-300 font-medium">
            Left4code
          </div>
      ...
      >
        <div>
          ...
          <div class="text-lg font-medium text-theme-17 dark:text-gray-300 mt-2">
        ...
        <div class="mt-10 lg:mt-0 lg:ml-auto lg:text-right">
          ...
          <div class="text-lg text-theme-17 dark:text-gray-300 font-medium mt-2">
            #1923195
          </div>
      ...
      <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row">
        ...
        <div class="text-center sm:text-right sm:ml-auto">
          ...
          <div class="text-xl text-theme-17 dark:text-gray-300 font-medium mt-2">
            $20.600.00
          </div>
